...
int register_device(void) {
  ...
  if (result < 0) {
    printk(KERN_WARNING "Hardware-Device:  can\'t register character device "
                        "with errorcode = %i\n",
           result);
    return result;
  }
  ...
  printk(KERN_NOTICE "Hardware-Device: registered character device with major "
                     "number = %i and minor numbers 0...255\n",
...
/*===============================================================================================*/
static ssize_t hardware_device_read(struct file *filp, char __user *buf,
                                    size_t len, loff_t *off) {
  // TODO: Implement the read function
}

/*===============================================================================================*/
static long hardware_device_ioctl(struct file *file, unsigned int cmd,
                                  unsigned long arg) {
