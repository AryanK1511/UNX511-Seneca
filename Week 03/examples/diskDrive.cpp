...
int main() {
  ...
  do {
    ...
    case 1:
      ...
      //              retVal = ioctl(file_descriptor, command,
      //              &parameter_or_structure);
      if (ret < 0) {
    ...
    case 2:
      ...
      if (ret < 0) {
        ...
        cout << "For " << diskFile << ", the device size is " << blockSize
             << " sectors" << endl;
      }
      ...
      if (ret < 0) {
        ...
        cout << "For " << disk1File << ", the device size is " << blockSize
             << " sectors" << endl;
      }
      sleep(2);
      break;
